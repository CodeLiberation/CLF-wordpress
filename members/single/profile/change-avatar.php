	...
	<form action="" method="post" id="avatar-upload-form" class="standard-form" enctype="multipart/form-data">
		...
		<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<p id="avatar-upload">
				...
				<input type="submit" name="upload" id="upload" class="button" value="<?php _e( 'Upload Image', 'buddypress' ); ?>" />
		...
		<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<input type="submit" name="avatar-crop-submit" id="avatar-crop-submit" class="button" value="<?php _e( 'Crop Image', 'buddypress' ); ?>" />
